...
const roundsData: Round[] = [
  ...
  },
  {
    ...
    pauseDuration: 10,
    questions: [
      { character: "Тинацу Кан", anime: "Голубая шкатулка", description: "Талантливая баскетболистка, старшеклассница, в которую влюблен главный герой.", image: "foto4/1.png" },
      { character: "Кейна Кагами", anime: "Мир Лидейл", description: "Девушка, очнувшаяся в мире своей любимой VRMMO через 200 лет после того, как перестала играть.", image: "foto4/2.png" },
      { character: "Pochita", anime: "Человек-бензопила", description: "Маленький оранжевый демон-собака с бензопилой на голове.", image: "foto4/3.png" },
      { character: "Принцесса рёвозавров (Код 001)", anime: "DARLING in the FRANXX", description: "Последняя из своего рода, управляет рёвозаврами и имеет синюю кожу.", image: "foto4/4.png" },
      { character: "Нао Томори", anime: "Шарлотта", description: "Президент школьного совета, способна становиться невидимой для одного человека.", image: "foto4/5.png" },
      { character: "Виллибальд", anime: "Сага о Винланде", description: "Молодой священник, который ищет истинное значение любви в мире викингов.", image: "foto4/6.png" },
      { character: "Лорд Демонов Диабло", anime: "О моем перерождении в слизь", description: "Один из Первородных демонов, фанатично преданный Римуру Темпесту.", image: "foto4/7.png" },
      { character: "Сатоко Ходжо", anime: "Когда плачут цикады", description: "Девочка, любящая ставить ловушки, чья судьба трагически переплетена с циклом смертей в деревне.", image: "foto4/8.png" },
      { character: "Рика Кава", anime: "Приоритет чудо-яйца", description: "Бывшая модель, которая присоединяется к группе девочек, сражающихся в мире снов.", image: "foto4/9.png" },
      { character: "Анри Сонохара", anime: "Дюрарара", description: "Тихая девушка в очках, которая является носителем проклятого меча Сайка.", image: "foto4/10.png" },
      { character: "Naoyuki Andō", anime: "Инуяшики", description: "Лучший друг главного героя, который помогает ему освоиться с новым механическим телом.", image: "foto4/11.png" },
      { character: "Нидзика Идзити", anime: "Одинокий рокер", description: "Энергичная барабанщица группы Kessoku Band, которая пригласила Хитори в группу.", image: "foto4/12.png" },
      { character: "Кохаку Итимура", anime: "Прекрасная вечерняя луна", description: "Девушка, которую часто принимают за парня из-за её внешности и манер.", image: "foto4/13.png" },
      { character: "Канамэ Судо", anime: "Игра Дарвина", description: "Игрок, втянутый в смертельную игру через мобильное приложение.", image: "foto4/14.png" },
      { character: "Асакадзэ", anime: "Sonny Boy", description: "Парень, обладающий способностью управлять гравитацией в странном пустом мире.", image: "foto4/15.png" },
      { character: "Сион Караномори", anime: "Психопаспорт", description: "Аналитик Бюро Общественной Безопасности, 'латентный преступник'.", image: "foto4/16.png" },
      { character: "Амамия", anime: "Рон Камонохаси: Невменяемый детектив", description: "Полицейский, который становится напарником гениального, но странного детектива.", image: "foto4/17.png" },
      { character: "Сюити Кагая", anime: "Глейпнир", description: "Парень, способный превращаться в огромный костюм собаки с молнией на спине.", image: "foto4/18.png" },
      { character: "Рин Окумура", anime: "Синий экзорцист", description: "Сын Сатаны, который решил стать экзорцистом, чтобы победить своего отца.", image: "foto4/19.png" },
      { character: "Крул Цепеш", anime: "Последний серафим", description: "Королева вампиров Японии, третья среди Основателей.", image: "foto4/20.png" }
    ]
  }
];
