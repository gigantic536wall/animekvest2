...
const roundsData: Round[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { text: "Сколько пальцев Сукуны нашёл Итадори к концу 1-го сезона аниме «Магическая битва»?", correctAnswer: "5" },
      ...
      { text: "Какой номер имеет истинный Клинок Сатаны (Курикара) в аниме «Синий экзорцист»?", correctAnswer: "Нет номера" },
  ...
  },
  {
    ...
    questions: [
      ...
      { description: "Сверхзастенчивая Хитори Гото. Она часами репетирует дома, надеясь стать популярной, и однажды её приглашают в настоящий коллектив. Теперь 'Тихоне' приходится преодолевать свои страхи ради музыки и новых друзей.", correctAnswer: "Одинокий рокер!" },
      ...
      { description: "Тысячи игроков оказываются заперты в виртуальном мире MMORPG, где смерть в игре означает смерть в реальности. Одиночка пытается пройти все 100 этажей парящей крепости, чтобы спасти всех.", correctAnswer: "САО (Sword Art Online)" },
      ...
      { description: "ГГ живёт в нищете, охотясь на демонов вместе с псом-бензопилой . После предательства он сливается со своим питомцем, обретая чудовищную силу. Теперь он работает в правительстве, мечтая о простой жизни и любви.", correctAnswer: "Человек-бензопила" },
  ...
  },
  {
    ...
    questions: [
      ...
      { text: "«Страх очень важное чувство, но не дай ему поработить тебя. Если твоё тело проиграет, попробуй победить душой.»", correctAnswer: "Повелитель (Overlord)" },
      ...
      { text: "«Что-то трупы разгулялись. К дождю, наверное.»", correctAnswer: "Когда плачут цикады (Higurashi no Naku Koro Ni)" },
      { text: "«— Если хотят умереть, пусть умирают. — Ну, знаешь ли... Нельзя так говорить! — Душа, способная на самоубийство, уже одержима. Не важно, жив человек или нет, его уже не спасти.»", correctAnswer: "Бездомный Бог (Noragami)" },
      ...
      { text: "«Живем один раз, поэтому я не собираюсь бежать, чтобы потом жалеть! Буду смотреть вперед, не оглядываясь назад!»", correctAnswer: "Гуррен Лаганн: Прочь из этого мира (Tengen Toppa Gurren Lagann)" },
      { text: "«Когда я была маленькой, я думала, что мир исчезнет, если я умру. Какая детская иллюзия. Существование мира, когда меня уже нет, казалось мне непростительным.»", correctAnswer: "Эрго Прокси (Ergo Proxy)" },
      { text: "«Словно в наказание, я продолжаю работать. Бездумно, лишь желая обо всём забыть. Свободное от работы время стало пыткой. Я просаживал деньги, пытаясь забыться. Казалось, всё рухнет, стоит мне оглянуться на окружающую реальность.»", correctAnswer: "Кланад " },
